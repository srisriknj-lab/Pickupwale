      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              Kannauj, located in Uttar Pradesh, is famously known as the "Perfume Capital of India". With a history stretching back to antiquity, it served as the imperial capital of Emperor Harshavardhana in the 7th century and is globally renowned for its centuries-old traditional ittar (perfume) distillation process.
            </p>
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              Based here, we understand the specific needs of handling fragile glass bottles, liquid shipments, bulk commercial cargo, and everyday business documents.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed font-medium">
              As an authorized <span className="text-brand-orange font-bold text-xl uppercase tracking-wider">DTDC Franchise</span> in Kannauj, we leverage one of India's most expansive logistics networks to ensure your valuable shipments arrive safely and on time.
            </p>
          </motion.div>
