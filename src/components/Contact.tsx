    ...
    <section id="contact" className="py-20 lg:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a 
                    href="https://maps.google.com/maps?q=Warsi%20Complex,%20Ajay%20Pal%20Road,%20Lakhan%20Chouraha,%20Kannauj%20209725" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="text-gray-600 hover:text-brand-orange transition-colors block leading-relaxed"
                  >
                    Warsi Complex, Ajay Pal Road<br/>Lakhan Chouraha, Kannauj 209725 (U.P.)
                  </a>
                </div>
              </div>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="mt-16 w-full h-[400px] rounded-3xl overflow-hidden shadow-2xl border border-gray-100"
        >
          <iframe 
            width="100%" 
            height="100%" 
            src="https://maps.google.com/maps?q=DTDC%20Courier,%20Warsi%20Complex,%20Ajay%20Pal%20Road,%20Lakhan%20Chouraha,%20Kannauj%20209725&t=&z=15&ie=UTF8&iwloc=&output=embed" 
            frameBorder="0" 
            scrolling="no" 
            marginHeight={0} 
            marginWidth={0}
            title="Pickupwale Location"
          ></iframe>
        </motion.div>
      </div>
    </section>
