      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          <div className="flex items-center gap-3">
            <img src="/src/assets/images/pickupwale_new_logo_1781715452666.jpg" alt="Pickupwale Logo" className="w-12 h-12 object-contain rounded-md shadow-sm border border-brand-blue/10" referrerPolicy="no-referrer" />
