...
export default function Hero() {
  return (
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-brand-blue-50 min-h-[90vh] flex items-center">
      <div className="absolute inset-0 z-0 opacity-40 background-pattern"></div>
      ...
      <div className="absolute bottom-0 left-0 -ml-32 -mb-32 w-[500px] h-[500px] rounded-full bg-blue-100/40 blur-[100px] pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center lg:text-left flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="flex-1 max-w-3xl">
          ...
          >
            ...
            <span className="text-sm font-semibold tracking-wide flex-1 text-brand-orange">Kannauj's Trusted Perfume & Attar Cargo Partner</span>
          </motion.div>
          ...
          <motion.h1 
            ...
            className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-brand-blue-900 leading-tight mb-6"
          >
            FREE Pickup At Your Door for <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-orange to-brand-orange-600">Perfume & Attar</span> Businesses
          </motion.h1>
          ...
          >
            ...
            <a 
              ...
              className="w-full sm:w-auto px-8 py-4 bg-white hover:bg-gray-50 text-brand-blue-900 border border-gray-200 shadow-sm rounded-full font-bold text-lg transition-all flex items-center justify-center gap-2"
            >
          ...
          >
            <a href="tel:7525027993" className="text-xl font-bold text-brand-blue-900 hover:text-brand-orange transition-colors flex items-center gap-2">
          ...
          <motion.div 
            ...
            className="mt-10 flex flex-wrap gap-4 items-center justify-center lg:justify-start text-sm text-gray-700 font-medium"
          >
        ...
        >
           <div className="relative">
             <div className="absolute inset-0 bg-gradient-to-tr from-brand-blue-50 to-transparent rounded-3xl z-10 opacity-60"></div>
             <img 
               src="/src/assets/images/attar_perfume_bottles_1781719713777.jpg" 
               alt="Traditional Attar and Perfume Bottles" 
               className="w-full h-[500px] object-cover rounded-3xl shadow-2xl relative z-0"
             />
